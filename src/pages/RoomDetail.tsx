...
const roomTypes = [
  {
    ...
    name: "Normal Room",
    description:
      "Our comfortable standard rooms provide all the essentials for a relaxing stay, featuring modern amenities and elegant design.",
  ...
  },
  {
    ...
    name: "Standard Room",
    description:
      "Enjoy additional space and premium amenities in our deluxe rooms, perfect for both business and leisure travelers seeking extra comfort.",
  ...
  },
  {
    ...
    name: "Suite Room",
    description:
      "Experience luxury in our spacious suites featuring separate living areas, premium furnishings, and exclusive amenities for the ultimate stay.",
    image: "/uploads/pexels-pixabay-271672.jpg",
  },
]
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="w-full bg-gray-100 py-8">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl font-serif text-hotel-primary"></h1>
